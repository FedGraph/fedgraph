...
for i in range(1, 11):
    plt.plot(
        ...
        grouped_by_dataset[f"Pretrain Network Large{i}"],
...
for i in range(1, 11):
    plt.plot(
        grouped_by_dataset["Dataset"],
        grouped_by_dataset[f"Train Network Large{i}"],
...
for i in range(1, 11):
    plt.plot(
        grouped_by_dataset["Dataset"],
        grouped_by_dataset[f"Pretrain Max Trainer Memory{i}"],
...
for i in range(1, 11):
    plt.plot(
        grouped_by_dataset["Dataset"],
        grouped_by_dataset[f"Train Max Trainer Memory{i}"],
