...
grouped_df = df.groupby(['Distribution Type', 'IID Beta'])[
...
plot_metric_vs_setting('Train Time', 'IID Beta',
                       'Training Time', 'Training Time vs IID Beta')

# Plot for Test Accuracy vs IID Beta
plot_metric_vs_setting('Average Test Accuracy', 'IID Beta',
                       'Test Accuracy', 'Test Accuracy vs IID Beta')

# Plot for Communication Cost vs IID Beta
plot_metric_vs_setting('Pretrain Network Large1', 'IID Beta',
                       'Communication Cost', 'Communication Cost vs IID Beta')

# Plot for Training Time vs Distribution Type
plot_metric_vs_setting('Train Time', 'Distribution Type',
                       'Training Time', 'Training Time vs Distribution Type')

# Plot for Test Accuracy vs Distribution Type
plot_metric_vs_setting('Average Test Accuracy', 'Distribution Type',
                       'Test Accuracy', 'Test Accuracy vs Distribution Type')

# Plot for Communication Cost vs Distribution Type
plot_metric_vs_setting('Pretrain Network Large1', 'Distribution Type',
                       'Communication Cost', 'Communication Cost vs Distribution Type')
