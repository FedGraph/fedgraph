...
gcfl_grouped = gcfl_data.groupby('Number of Trainers').agg({
...
plt.figure()
plt.plot(gcfl_grouped['Number of Trainers'], gcfl_grouped['Pretrain Network'],
         label='Pretrain Network', color='tab:blue', marker='o')
plt.plot(gcfl_grouped['Number of Trainers'], gcfl_grouped['Train Network'],
         label='Train Network', color='tab:orange', marker='o')
...
plt.figure()
plt.plot(gcfl_grouped['Number of Trainers'], gcfl_grouped['Pretrain Max Trainer Memory'],
         label='Pretrain Max Trainer Memory', color='tab:green', marker='x')
plt.plot(gcfl_grouped['Number of Trainers'], gcfl_grouped['Train Max Trainer Memory'],
         label='Train Max Trainer Memory', color='tab:red', marker='x')
plt.xlabel('Number of Trainers')
